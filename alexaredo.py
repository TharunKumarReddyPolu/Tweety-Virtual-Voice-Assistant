...
print('Loading your AI Virtual Assistant - Tweety')
speak("Loading your AI Virtual Assistant - Tweety")
wishMe()
...
def wishMe():
    ...
    if hour>=0 and hour<12:
        speak("Hello, Good Morning, How may I assist you?")
        print("Hello,Good Morning, How may I assist you?")
    elif hour>=12 and hour<18:
        speak("Hello,Good Afternoon, How may I assist you?")
        print("Hello,Good Afternoon, How may I assist you?")
    else:
        speak("Hello,Good Evening, How may I assist you?")
...
def takeCommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print(f'user command:{statement}\n')
